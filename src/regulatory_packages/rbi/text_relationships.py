"""Infer RBI regulatory relationships from extracted PDF/text bodies."""
...
from regulatory_packages.rbi.relationships import DocumentIndex, build_relationships
...
_IMPLEMENTS_PATTERNS = [
    ...
    re.compile(
        r"\bsection\s+\d+[A-Za-z()0-9]*\s+of\s+the\s+(?:Reserve Bank of India|Banking Regulation|Foreign Exchange Management)\s+Act\b",
        re.I,
    ),
]
