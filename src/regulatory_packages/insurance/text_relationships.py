"""Infer IRDAI regulatory relationships from extracted PDF/text bodies."""
...
from regulatory_packages.insurance.relationships import DocumentIndex, build_relationships
...
_IMPLEMENTS_PATTERNS = [
    ...
    re.compile(r"\bsection\s+\d+[A-Za-z()0-9]*\s+of\s+the\s+(?:IRDAI|IRDAI|IRDAI|IRDAI)\s+Act\b", re.I),
]
